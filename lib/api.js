...
// Use proxy endpoint for Netlify to bypass CORS
const API_URL = typeof window !== 'undefined' && window.location.hostname !== 'hellobd.news'
  ? '' // relative path, so /api/frontend will hit the local proxy
  : NEXT_PUBLIC_API_URL;
...
const api = axios.create({
  ...
  timeout: 30000, // Increased to 30s for large responses
  headers: {
