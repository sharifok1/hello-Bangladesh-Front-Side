...
export default function HomePage() {
  ...
  // Additional data for slider components
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([homeRes, adsRes, settingsRes]) => {
        ...
        setEconomy(postsData?.economy_popular_news || []);
        setTechnology(postsData?.technology_popular_news || []);
        setCountry(postsData?.country_popular_news || []);
        setScience(postsData?.science_popular_news || []);
        setEngineering(postsData?.engineering_popular_news || []);
        setHealth(postsData?.health_popular_news || []);
        setSuccessStory(postsData?.success_storys_popular_news || []); 
        setEducation(postsData?.education_popular_news || []);
        setEnvironment(postsData?.environment_popular_news || []);
        setInterview(postsData?.interview_popular_news || []);
        setCorporate(postsData?.corporate_popular_news || []);
    ...
    <div className="min-h-screen font-roboto" style={{backgroundColor: '#FFFFFF'}}>
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner1.title || 'Advertisement 1 full width'}
                      />
                    </div>
                  </a>
                </div>
     ...
     {/* ----------------------------------------section 4   বিশ্ব খবর------------------------------------------------- */}
      ...
      <div className='w-full' style={{backgroundColor:'#EE00AB'}}>
        <Image src="https://dev.hellobd.news/storage/media/binodon_bg-line_2026-02-01_09-04-03_dF789rQD.svg" alt="wave-pattern" className='w-full py-4' style={{ height: 'auto' }} width={150} height={150}/>
          <div className='container mx-auto px-4 '>
             <div className='mx-auto text-center pb-2'>
              ...
              <Image src="https://dev.hellobd.news/storage/media/binodon_bg-line_2026-02-01_09-04-03_dF789rQD.svg" alt="wave-pattern" className='w-full pt-8 pb-4' style={{ height: 'auto' }} width={150} height={150}/>
      </div> 
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner3.title || 'Advertisement full width'}
      ...
      <section className='w-full' style={{backgroundColor:'#EC7100'}}>
        <Image src="https://dev.hellobd.news/storage/media/life-style_2026-02-01_09-23-11_SZBs1yDc.svg" alt="wave-pattern" className='w-full pb-2' style={{ height: 'auto' }} width={150} height={150}/>
          <div className='container mx-auto px-4'>
             <div className='mx-auto text-center pb-6'>
              ...
              <Image src="https://dev.hellobd.news/storage/media/life-style_2026-02-01_09-23-11_SZBs1yDc.svg" alt="wave-pattern" className='w-full pt-8' style={{ height: 'auto' }} width={150} height={150}/>
      </section>
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner4.title || 'Advertisement 4 full width'}
                      />
                    </div>
                  </a>
                </div>
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner5.title || 'Advertisement 5 full width'}
                      />
                    </div>
                  </a>
                </div>
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner6.title || 'Advertisement 6 full width'}
                      />
                    </div>
                  </a>
                </div>
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner7.title || 'Advertisement 7 full width'}
                      />
                    </div>
                  </a>
                </div>
                  ...
                  >
                    <div className="w-full bg-yellow-50 rounded overflow-hidden border-2 border-yellow-200">
                      <Image
                        ...
                        width={1200}
                        height={100}
                        alt={fullWidthBanner8.title || 'Advertisement 8 full width'}
                      />
                    </div>
                  </a>
                </div>
